  ...
  return (
    <div className="h-full w-full flex flex-col md:flex-row items-center justify-center md:justify-between xl:w-[90%] xl:gap-4">
      <div className=" md:-translate-x-28 h-[30%] md:h-auto md:w-[35%]">
        <div
          className={`ml-4 min-w-[300px] relative ${
            aspectRatio > 1.2
              ? "md:min-h-[calc(100%+40px)]"
              : "md:min-w-[calc(100%+40px)]"
          } aspect-square border-theme rounded-full border-[3px] flex items-center justify-center`}
        >
          <div className="w-[280px] overflow-hidden md:min-w-[calc(100%-20px)] xl2:min-w-[calc(100%-40px)] aspect-square rounded-full bg-theme">
            <img src={AboutPic} alt="" className="w-full md:min-w-full z-[1]" />
          </div>
        </div>
      </div>
      <div
        ref={aboutRef}
        className="md:h-full p-2 flex items-center xl3:gap-10 w-full sm:w-[90%] md:w-[65%]"
      >
        <div
          className={`w-full space-y-4 xl3:space-y-8 ${
            aspectRatio > 1.2 && "h-full"
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <p className="secondary-font indent-12 text-xs xxs:text-sm xs:text-base md:text-xs lg:text-base xl:text-lg 2xl:text-xl xl2:text-2xl xl3:text-3xl">
              I’m <span className="font-medium">Govind Ravi</span>, a dedicated
              software developer with expertise in both frontend and backend
              technologies. I specialize in the MERN stack (MongoDB, Express.js,
              React, Node.js), leveraging these tools to build scalable and
              efficient applications. My passion lies in crafting innovative
              solutions and continuously enhancing my technical skills. I’m
              enthusiastic about tackling new challenges and making a positive
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs xxs:text-sm xs:text-base md:text-xs lg:text-sm xl:text-base 2xl:text-base xl2:text-xl xl3:text-2xl">
              <li>
                <span className="font-medium">AI Proficiency:</span> Skilled in
                leveraging AI for smart solutions
              </li>
              <li>
                <span className="font-medium">Sports:</span> Table Tennis, Pool,
                Chess
              </li>
              <li>
