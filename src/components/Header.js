...
const Header = forwardRef((props,ref ) => {
  return (
    <nav ref={ref} className='p-1 xxs:p-2 md:px-4 ml:px-6 lg:px-10 xl:py-6 2xl:px-16 2xl:py-6 flex flex-col sm:flex-row gap-2 sm:gap-1 justify-between items-center'>
      <div className='flex items-center'>
        <div className='w-14 xsm:w-16 md:w-20'><img src={Logo} alt="Logo" /></div>
        <span className='font-medium text-3xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl xl2:text-7xl'>TechPortfolio</span>
      </div>
