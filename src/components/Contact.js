...
function Contact() {
  ...
  return (
    <footer ref={contactRef} className="flex items-center h-full text-sm lg:text-base 2xl:text-xl xl2:text-3xl xl3:text-4xl overflow-y-scroll">
      <div className={`flex flex-col items-center gap-6 ml:gap-7 lg:gap-8 xl:gap-10 xl3:gap-14 mt-8 ${aspectRatio > 2.5 && "h-full"} `}>
        <div>
          <h1 className="text-3xl ml:text-4xl lg:text-5xl xl2:text-7xl xl3:text-8xl font-semibold text-center mb-2 xl2:mb-4 text-theme">
        ...
        <div className="flex gap-6 ml:gap-8 lg:gap-10">
        ...
        <div className="flex gap-6 lg:gap-8 xl2:gap-10 xl3:gap-12">
          <div className="w-7 ml:w-8 lg:w-10 xl2:w-16 xl3:w-20">
