...
function Contact() {
  return (
    <footer className="flex items-center h-full text-sm lg:text-base 2xl:text-xl xl2:text-3xl xl3:text-4xl overflow-y-scroll">
      <div className="flex flex-col items-center gap-8 xl:gap-10 xl3:gap-14 mt-8">
        <div>
          <h1 className="text-5xl xl2:text-7xl xl3:text-8xl font-semibold text-center mb-2 xl2:mb-4 text-theme">
            Have a project in mind?
          </h1>
          <p className="text-center w-3/4 xl:w-2/3 mx-auto text-secondary">
        ...
        <div className=" flex flex-col items-center gap-2 ">
          <p className="flex items-center gap-2">
            <MdEmail className="text-theme" size={24} />
            govindnr20122001@gmail.com
          </p>
          <p className="flex items-center gap-2">
            <MdCall className="text-theme" size={24} />
            +91 8792589747
          </p>
          <p className="flex items-center gap-2">
            <FaLocationDot className="text-theme" size={24} />
            Bengaluru, Karnataka
          </p>
        </div>
        <div className="flex gap-10">
          <a href="mailto:govindnr20122001@gmail.com?subject=Hiring%20for%20[Job Position]&body=Dear%20Govind,%0A%0AI%20am%20interested%20in%20hiring%20you%20for%20[Job%20Postion]%0A%0A[Job%20Details]">
            <button className="border-theme shadow shadow-theme border-2 px-4 py-2 rounded font-medium transition duration-300 ease-in-out transform hover:scale-105">
              Hire Me
            </button>
          </a>
        ...
        <div className="flex gap-8 xl2:gap-10 xl3:gap-12">
          <div className="w-10 xl2:w-16 xl3:w-20">
